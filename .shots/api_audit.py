...
ALIAS = {
    ...
    'DatePicker.Render Props.isDisabled': 'content',
    'DatePicker.Render Props.isInvalid': 'content',
    'DatePicker.Render Props.isReadOnly': 'content',
    'DatePicker.Render Props.isRequired': 'content',
    'DatePicker.Render Props.isFocusWithin': 'content',
    'DatePicker.Render Props.isFocusVisible': 'content',
    'DatePicker.Render Props.isOpen': 'content',
    'DatePicker.shouldCloseOnSelect': 'should_close_on_select',
    'DatePicker.TriggerIndicator.children': 'trigger_indicator',
    'DateRangePicker.Render Props.isDisabled': 'content',
    'DateRangePicker.Render Props.isInvalid': 'content',
    'DateRangePicker.Render Props.isReadOnly': 'content',
    'DateRangePicker.Render Props.isRequired': 'content',
    'DateRangePicker.Render Props.isFocusWithin': 'content',
    'DateRangePicker.Render Props.isFocusVisible': 'content',
    'DateRangePicker.Render Props.isOpen': 'content',
    'DateRangePicker.shouldCloseOnSelect': 'should_close_on_select',
    'DateRangePicker.TriggerIndicator.children': 'trigger_indicator',
    'DateRangePicker.RangeSeparator.children': 'range_separator',
    'TimeField.isFocused': 'content', 'TimeField.isFocusVisible': 'content',
    'TimeField.isFocusWithin': 'content',
    'TextField.Render Props.isDisabled': 'content',
    'TextField.Render Props.isInvalid': 'content',
    'TextField.Render Props.isReadOnly': 'content',
    'TextField.Render Props.isRequired': 'content',
    'TextField.Render Props.isFocused': 'content',
    'TextField.Render Props.isFocusWithin': 'content',
    'TextField.Render Props.isFocusVisible': 'content',
