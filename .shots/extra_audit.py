...
EXTRA_OK_SCOPED = {
    ...
    'Switch.hover_bg': 'no-classname',
    'Checkbox.hover_bg': 'no-classname',
    'Calendar.day_hover_bg': 'no-classname',
    'RangeCalendar.day_hover_bg': 'no-classname',
    'Calendar.nav_hover_bg': 'no-classname',
    ...
    'Select.trigger_text_size': 'no-classname',
    'Select.row_text_size': 'no-classname',
    'Select.panel_padding': 'no-classname',
    'Dropdown.panel_min_width': 'no-classname',
    'Dropdown.panel_max_width': 'no-classname',
    'Dropdown.panel_max_height': 'no-classname',
    'Dropdown.row_height': 'no-classname',
    'Dropdown.row_padding_x': 'no-classname',
    'Dropdown.row_padding_y': 'no-classname',
    'Dropdown.row_text_size': 'no-classname',
    ...
    'Slider.steps': 'repository-slider-extension',
    'Slider.on_drag_start': 'repository-slider-extension',
    'Slider.on_drag_end': 'repository-slider-extension',
    'Dropdown.focus_handle': 'state-entity',
    'Dropdown.on_dismiss': 'composition',
