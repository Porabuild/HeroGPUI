      ...
      <div className="mx-auto flex w-full max-w-[1440px] flex-col gap-6 px-4 py-10 sm:px-6 md:flex-row md:items-start md:justify-between">
        ...
        <nav aria-label="Footer navigation">
          ...
          <ul className="site-footer-nav flex flex-wrap items-center gap-x-6 gap-y-2 text-sm">
            <li>
              <Link
                className="-my-2.5 flex items-center gap-1.5 py-2.5 text-muted transition-colors hover:text-foreground"
                href={SITE.github}
                rel="noopener noreferrer"
                target="_blank"
              >
            ...
            <li>
              <Link
                className="-my-2.5 py-2.5 text-muted transition-colors hover:text-foreground"
                href={SITE.cratesio}
                rel="noopener noreferrer"
                target="_blank"
              >
