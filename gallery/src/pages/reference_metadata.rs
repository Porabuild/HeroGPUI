...
const DATE_FIELD_API: &[ApiDoc] = &[
    ...
    ApiDoc { owner: "DateField", prop: "shouldForceLeadingZeros", ty: "boolean", default: "locale", description: "Forces two-digit month, day and hour segments; otherwise each follows the system regional pattern while minutes and seconds remain two digits.", rust_owner: "DateField", rust: "should_force_leading_zeros(bool)", status: ImplementationStatus::Implemented },
...
const TIME_FIELD_API: &[ApiDoc] = &[
    ...
    ApiDoc { owner: "TimeField", prop: "shouldForceLeadingZeros", ty: "boolean", default: "locale", description: "Forces a two-digit hour when true; otherwise the hour follows the system regional pattern while minutes and seconds remain two digits.", rust_owner: "TimeField", rust: "should_force_leading_zeros(bool)", status: ImplementationStatus::Implemented },
