...
pub(super) const SCROLL_SHADOW: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(utilities)/scroll-shadow.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/scroll-shadow/scroll-shadow.tsx + https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/scroll-shadow/use-scroll-shadow.ts",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/scroll-shadow.css",
