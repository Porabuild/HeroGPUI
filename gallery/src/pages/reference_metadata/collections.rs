...
const DROPDOWN_API: &[ApiDoc] = &[
    ...
    ApiDoc {
        ...
        ty: "string",
        default: "—",
        description: "Additional CSS classes for the menu. Standalone Menu provides panel sizing, row metrics and panel_padding builders; sx styles its outer wrapper.",
        rust_owner: "Menu",
        rust: "—",
        status: ImplementationStatus::Unavailable,
    },
