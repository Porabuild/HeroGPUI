...
const DROPDOWN_API: &[ApiDoc] = &[
    ...
    ApiDoc {
        ...
        ty: "PopoverPlacement",
        default: "\"bottom\"",
        description: "Placement relative to the measured trigger. All 22 union placements flip to the side with more room when the preferred side cannot fit, keeping a 12px cross-axis viewport inset with the scroller capped to the available height.",
        rust_owner: "Dropdown",
...
const DROPDOWN_STYLING: &[StyleDoc] = &[
    ...
    StyleDoc {
        ...
        description: "Positions against the measured trigger; all 22 union placements flip to the side with more room when the preferred side cannot fit, keeping a 12px cross-axis viewport inset with the scroller capped to the available height. Overlay surface.",
...
pub(super) const DROPDOWN: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.5",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(collections)/dropdown.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/dropdown/dropdown.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/dropdown.css",
...
const LIST_BOX_STYLING: &[StyleDoc] = &[
    ...
    StyleDoc { class_or_token: ".list-box-item pressed", value: "scale(0.98); transform 250ms ease-out-quart", description: "Enabled options animate to 98% through the pinned quart curve inside a stable row slot, so measurement, focus and pointer ownership do not move during a press.", rust: "anim::pressed_with_background_ramp(LIST_ITEM_PRESS, PRESSED_SCALE_SUBTLE)", status: ImplementationStatus::Implemented },
    ...
    StyleDoc { class_or_token: ".list-box-item__indicator", value: "absolute end-2 size-4 text-default-foreground", description: "Size, end offset, vertical centering and default/danger colors match; the row reserves the pinned 28px end padding for both built-in and custom indicators.", rust: "absolute trailing 16px indicator + pr(28px)", status: ImplementationStatus::Implemented },
...
pub(super) const LIST_BOX: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.5",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(collections)/list-box.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/list-box/list-box.tsx + https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/list-box-item/list-box-item.tsx + https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/list-box-section/list-box-section.tsx + https://github.com/adobe/react-spectrum/blob/react-aria-components@1.21.0/packages/react-aria-components/src/ListBox.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/list-box.css + https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/list-box-item.css + https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/list-box-section.css",
...
const TAG_GROUP_STYLING: &[StyleDoc] = &[
    ...
    StyleDoc { class_or_token: ".tag transitions", value: "color/scale/opacity/background 100ms ease-smooth; shadow 100ms ease-out", description: "Background colors now interpolate through the pinned 100ms ease-smooth track on a stable rounded fill; color, scale, opacity and shadow endpoints that have no portable property animation remain state-swapped.", rust: "anim::hover_fade_with_duration_and_easing + stable interaction slot", status: ImplementationStatus::Partial },
    ...
    StyleDoc { class_or_token: ".tag__remove-button", value: "touch-target size-3 text-inherit", description: "The 24px pointer target surrounds a 12px glyph without changing tag layout. The composed CloseButton surface is not exposed independently.", rust: "24px remove target, 12px layout and glyph", status: ImplementationStatus::Partial },
];
...
pub(super) const TAG_GROUP: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.5",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(collections)/tag-group.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/tag-group/tag-group.tsx + https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/tag/tag.tsx + https://github.com/adobe/react-spectrum/blob/react-aria-components@1.21.0/packages/react-aria-components/src/TagGroup.tsx + https://github.com/adobe/react-spectrum/blob/react-aria-components@1.21.0/packages/react-aria/src/tag/useTagGroup.ts",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/tag-group.css + https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/tag.css + https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/close-button.css",
