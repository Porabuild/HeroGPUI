...
const TOAST_API: &[ApiDoc] = &[
    ...
    ApiDoc { owner: "Toast.Provider", prop: "maxVisibleToasts", ty: "number", default: "3", description: "Limits rendered cards without evicting or pausing queued entries. Overflow stays mounted as hidden cards.", rust_owner: "ToastViewport", rust: "max_visible_toasts(usize)", status: ImplementationStatus::Implemented },
    ApiDoc { owner: "Toast.Provider", prop: "isExpanded", ty: "boolean", default: "false", description: "Forces the stack open when more than one toast is active. Hover and focus-within still expand when this is false; the prop does not pause timers.", rust_owner: "ToastViewport", rust: "is_expanded(bool)", status: ImplementationStatus::Implemented },
