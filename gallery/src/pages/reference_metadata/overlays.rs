...
pub(super) const DRAWER: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(overlays)/drawer.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/drawer/drawer.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/drawer.css",
...
pub(super) const MODAL: ReferenceMetadata = ReferenceMetadata {
    ...
    source_module: "modal",
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(overlays)/modal.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/modal/modal.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/modal.css",
...
pub(super) const POPOVER: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(overlays)/popover.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/popover/popover.tsx + https://github.com/adobe/react-spectrum/blob/react-aria-components@1.21.1/packages/react-aria-components/src/Popover.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/popover.css",
...
const TOOLTIP_API: &[ApiDoc] = &[
    ...
    ApiDoc { owner: "Tooltip", prop: "delay", ty: "number", default: "1500", description: "The pinned HeroUI docs table says 700; v3.2.6 runtime resolves 1500 from --tooltip-delay, matching pinned React Stately's default.", rust_owner: "Tooltip", rust: "delay(u64)", status: ImplementationStatus::Implemented },
    ApiDoc { owner: "Tooltip", prop: "closeDelay", ty: "number", default: "500", description: "The pinned HeroUI docs table says zero; v3.2.6 runtime resolves 500 from --tooltip-close-delay, matching pinned React Stately's default.", rust_owner: "Tooltip", rust: "close_delay(u64)", status: ImplementationStatus::Implemented },
...
pub(super) const TOOLTIP: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(overlays)/tooltip.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/tooltip/tooltip.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/tooltip.css",
...
pub(super) const TOAST: ReferenceMetadata = ReferenceMetadata {
    ...
    source_module: "toast",
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(overlays)/toast.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/toast/toast.tsx + https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/toast/toast-queue.ts + https://github.com/adobe/react-spectrum/blob/react-aria-components@1.21.1/packages/react-stately/src/toast/useToastState.ts",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/toast.css",
...
pub(super) const ALERT_DIALOG: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(overlays)/alert-dialog.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/alert-dialog/alert-dialog.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/alert-dialog.css",
