...
pub(super) const PROGRESS_BAR: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(feedback)/progress-bar.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/progress-bar/progress-bar.tsx + https://github.com/adobe/react-spectrum/blob/react-aria-components@1.21.1/packages/react-aria-components/src/ProgressBar.tsx + https://github.com/adobe/react-spectrum/blob/react-aria@3.52.1/packages/react-aria/src/progress/useProgressBar.ts",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/progress-bar.css",
...
pub(super) const PROGRESS_CIRCLE: ReferenceMetadata = ReferenceMetadata {
    ...
    source_module: "progress",
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(feedback)/progress-circle.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/progress-circle/progress-circle.tsx + https://github.com/adobe/react-spectrum/blob/react-aria-components@1.21.1/packages/react-aria-components/src/ProgressBar.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/progress-circle.css",
...
pub(super) const ALERT: ReferenceMetadata = ReferenceMetadata {
    ...
    source_module: "alert",
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(feedback)/alert.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/alert/alert.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/alert.css",
...
pub(super) const METER: ReferenceMetadata = ReferenceMetadata {
    ...
    source_module: "meter",
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(feedback)/meter.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/meter/meter.tsx + https://github.com/adobe/react-spectrum/blob/react-aria-components@1.21.1/packages/react-aria-components/src/Meter.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/meter.css",
...
pub(super) const SKELETON: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(feedback)/skeleton.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/skeleton/skeleton.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/skeleton.css",
...
pub(super) const SPINNER: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(feedback)/spinner.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/spinner/spinner.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/spinner.css",
