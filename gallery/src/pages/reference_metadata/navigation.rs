...
pub(super) const PAGINATION: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(navigation)/pagination.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/pagination/pagination.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/pagination.css",
...
pub(super) const TABS: ReferenceMetadata = ReferenceMetadata {
    ...
    source_module: "tabs",
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(navigation)/tabs.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/tabs/tabs.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/tabs.css",
...
pub(super) const ACCORDION: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(navigation)/accordion.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/accordion/accordion.tsx + https://github.com/adobe/react-spectrum/blob/react-aria-components@1.21.1/packages/react-aria-components/src/Disclosure.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/accordion.css",
...
pub(super) const DISCLOSURE: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(navigation)/disclosure.mdx + https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(navigation)/disclosure-group.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/disclosure/disclosure.tsx + https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/disclosure-group/disclosure-group.tsx + https://github.com/adobe/react-spectrum/blob/react-aria-components@1.21.1/packages/react-aria-components/src/Disclosure.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/disclosure.css + https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/disclosure-group.css",
...
const BREADCRUMBS_STYLING: &[StyleDoc] = &[
    StyleDoc {
        ...
        value: "flex items-center gap-1.5",
        description: "One line, items centred, no wrap, 6px between items.",
        rust: "root flex items_center gap(px(6.))",
        status: ImplementationStatus::Implemented,
    },
    StyleDoc {
        class_or_token: ".breadcrumbs__link",
        value: "relative text-sm leading-5 font-medium text-muted no-underline opacity-100",
        description: "14px medium muted link text on a fixed 20px line box with no padding of its own; leading-5 is a fixed height, not a ratio of the text size.",
        rust: "text_size(px(14.)) + line_height(px(20.)) + FontWeight::MEDIUM + muted",
        status: ImplementationStatus::Implemented,
    },
    StyleDoc {
    ...
    StyleDoc {
        ...
        value: "flex shrink-0 items-center justify-center gap-1",
        description: "A 4px gap between link and separator, no padding, and content that never compresses when the bar outgrows its parent.",
        rust: "row flex + flex_shrink_0 + items_center + justify_center + gap(px(4.))",
        status: ImplementationStatus::Implemented,
    },
    StyleDoc {
...
pub(super) const BREADCRUMBS: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(navigation)/breadcrumbs.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/breadcrumbs/breadcrumbs.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/breadcrumbs.css",
...
pub(super) const LINK: ReferenceMetadata = ReferenceMetadata {
    ...
    source_module: "link",
    version: "3.2.6",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/apps/docs/content/docs/en/react/components/(navigation)/link.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/react/src/components/link/link.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.6/packages/styles/components/link.css",
