...
pub(super) const CHECKBOX: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.5",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(forms)/checkbox.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/checkbox/checkbox.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/checkbox.css",
...
pub(super) const CHECKBOX_GROUP: ReferenceMetadata = ReferenceMetadata {
    ...
    source_module: "checkbox",
    version: "3.2.5",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(forms)/checkbox-group.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/checkbox-group/checkbox-group.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/checkbox-group.css",
...
const RADIO_GROUP_STATES: &[StateDoc] = &[
    ...
    StateDoc {
        ...
        description: "v3 changes the selected or variant-specific indicator fill on hover and adds the field-border hover layer; selected rest state keeps its accent edge transparent.",
        rust: "interaction hovered + selected/variant hover fill + border precedence",
        status: ImplementationStatus::Implemented,
    },
    StateDoc {
        state: "Focus visible",
...
const RADIO_GROUP_STYLING: &[StyleDoc] = &[
    ...
    StyleDoc {
        ...
        description: "Primary selection box and field chrome; selected rest state clears the configured field border before hover or invalid precedence.",
        rust: "16px + key_radius + field background/shadow + selected transparent border",
        status: ImplementationStatus::Implemented,
    },
    StyleDoc {
...
pub(super) const RADIO_GROUP: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.5",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(forms)/radio-group.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/radio-group/radio-group.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/radio-group.css",
...
const INPUT_API: &[ApiDoc] = &[
    ...
    ApiDoc { owner: "Input", prop: "focusRing", ty: "boolean", default: "true", description: "GPUI extension: hides only the visual focus ring while retaining focus, editing and invalid feedback.", rust_owner: "Input", rust: "focus_ring(bool)", status: ImplementationStatus::Implemented },
];
...
const INPUT_STYLING: &[StyleDoc] = &[
    ...
    StyleDoc { class_or_token: ".input transitions", value: "background/border 150ms Smooth; shadow 150ms Out; reduced-motion none", description: "Enabled, unfocused fields interpolate their background through the pinned 150ms ease-smooth transition; the border endpoint remains immediate and reduced motion settles directly.", rust: "hover_fade_with_duration_and_easing(150ms, EaseSmooth) + apply_field_chrome", status: ImplementationStatus::Implemented },
...
pub(super) const INPUT: ReferenceMetadata = ReferenceMetadata {
    ...
    source_module: "input",
    version: "3.2.5",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(forms)/input.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/input/input.tsx + https://github.com/adobe/react-spectrum/blob/react-aria-components@1.21.0/packages/react-aria-components/src/Input.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/input.css",
...
const TEXT_FIELD_API: &[ApiDoc] = &[
    ...
    ApiDoc { owner: "TextField", prop: "id", ty: "string", default: "—", description: "The caller-owned InputState entity supplies stable GPUI identity instead of a DOM id. Simultaneous fields need distinct InputState owners.", rust_owner: "TextField", rust: "new(state)", status: ImplementationStatus::Partial },
    ...
    ApiDoc { owner: "TextField", prop: "focusRing", ty: "boolean", default: "true", description: "GPUI extension: hides only the inner input's visual focus ring while retaining focus and editing.", rust_owner: "TextField", rust: "focus_ring(bool)", status: ImplementationStatus::Implemented },
...
pub(super) const TEXT_FIELD: ReferenceMetadata = ReferenceMetadata {
    ...
    source_module: "input",
    version: "3.2.5",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(forms)/text-field.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/textfield/textfield.tsx + https://github.com/adobe/react-spectrum/blob/react-aria-components@1.21.0/packages/react-aria-components/src/TextField.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/textfield.css",
...
const TEXT_AREA_API: &[ApiDoc] = &[
    ...
    ApiDoc { owner: "TextArea", prop: "focusRing", ty: "boolean", default: "true", description: "GPUI extension: hides only the visual focus ring while retaining focus and editing.", rust_owner: "TextArea", rust: "focus_ring(bool)", status: ImplementationStatus::Implemented },
...
const TEXT_AREA_STYLING: &[StyleDoc] = &[
    ...
    StyleDoc { class_or_token: ".textarea min-height", value: "38px; rows default 3", description: "Rows use one 20px line each plus 16px vertical padding and keep HeroUI's 38px minimum floor for rows(0) and rows(1); the documented three-row default is 76px.", rust: "rows_height(rows) = max(rows * 20px + 16px, 38px)", status: ImplementationStatus::Implemented },
    ...
    StyleDoc { class_or_token: ".textarea transitions", value: "background/border 150ms Smooth; shadow 150ms Out; reduced-motion none", description: "TextArea delegates its editable chrome to Input, whose enabled unfocused background interpolates through the pinned 150ms ease-smooth transition and settles under reduced motion.", rust: "inner Input hover_fade_with_duration_and_easing(150ms, EaseSmooth)", status: ImplementationStatus::Implemented },
...
pub(super) const TEXT_AREA: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.5",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(forms)/text-area.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/textarea/textarea.tsx + https://github.com/adobe/react-spectrum/blob/react-aria-components@1.21.0/packages/react-aria-components/src/TextArea.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/textarea.css",
...
const INPUT_GROUP_API: &[ApiDoc] = &[
    ...
    ApiDoc { owner: "InputGroup", prop: "focusRing", ty: "boolean", default: "true", description: "GPUI extension: hides only the group's visual focus ring while retaining the held field's focus and editing behavior.", rust_owner: "InputGroup", rust: "focus_ring(bool)", status: ImplementationStatus::Implemented },
...
const INPUT_GROUP_STATES: &[StateDoc] = &[
    ...
    StateDoc { state: "Focus Within", selector: ".input-group:has([data-slot=\"input-group-input\"]:focus)", description: "The held field's focus drives the group's status-focused-field ring, field-border-focus endpoint and pinned --field-focus fill.", rust: "apply_field_chrome(focus_within) + bg(field.focus/default)", status: ImplementationStatus::Implemented },
    StateDoc { state: "Invalid", selector: ".input-group[data-invalid=true]", description: "status-invalid-field draws the danger outline and focused danger ring, with the pinned --field-focus fill on both variants.", rust: "apply_field_chrome(is_invalid) + bg(field.focus/default)", status: ImplementationStatus::Implemented },
...
const INPUT_GROUP_STYLING: &[StyleDoc] = &[
    ...
    StyleDoc { class_or_token: ".input-group focus-within", value: "status-focused-field; border-color --field-border-focus; background --field-focus", description: "The two-pixel focus ring, focus border and field-focus fill match the pinned shell.", rust: "apply_field_chrome(focus_within) + bg(field.focus/default)", status: ImplementationStatus::Implemented },
    StyleDoc { class_or_token: ".input-group[data-invalid=true]", value: "status-invalid-field; background --field-focus; border --color-field-border-invalid", description: "Danger outline, focused danger ring and field-focus fill match both variants.", rust: "apply_field_chrome(is_invalid) + bg(field.focus/default)", status: ImplementationStatus::Implemented },
    ...
    StyleDoc { class_or_token: ".input-group__input[data-slot=\"input-group-textarea\"]", value: "min-height: 38px; resize: vertical", description: "The rows math keeps one 20px line over 16px of vertical padding and enforces HeroUI's 38px one-row floor. Browser resizing has no analogue.", rust: "multiline min_h rows_height(line * 20px + 16px).max(38px)", status: ImplementationStatus::Partial },
    StyleDoc { class_or_token: ".input-group__prefix / __suffix", value: "flex h-full items-center justify-center px-3 text-field-placeholder; side borders", description: "The 12px inset, placeholder colour, flush edges and prefix/suffix field-border seams match; arbitrary child addons inherit the same wrapper treatment.", rust: "addon slot wrapper + InputAddon px(12px) + border_r/border_l", status: ImplementationStatus::Implemented },
...
pub(super) const INPUT_GROUP: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.5",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(forms)/input-group.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/input-group/input-group.tsx + https://github.com/adobe/react-spectrum/blob/react-aria-components@1.21.0/packages/react-aria-components/src/Group.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/input-group.css",
...
const SEARCH_FIELD_API: &[ApiDoc] = &[
    ...
    ApiDoc { owner: "SearchField", prop: "focusRing", ty: "boolean", default: "true", description: "GPUI extension: hides only the input's visual focus ring while retaining focus, editing and clear behavior.", rust_owner: "SearchField", rust: "focus_ring(bool)", status: ImplementationStatus::Implemented },
...
pub(super) const SEARCH_FIELD: ReferenceMetadata = ReferenceMetadata {
    ...
    source_module: "input",
    version: "3.2.5",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(forms)/search-field.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/search-field/search-field.tsx + https://github.com/adobe/react-spectrum/blob/react-aria-components@1.21.0/packages/react-aria-components/src/SearchField.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/search-field.css",
...
const INPUT_OTP_STATES: &[StateDoc] = &[
    StateDoc {
        ...
        description: "Hovered slot surface and field-border color follow the active variant while active/filled slots retain their focus background.",
        rust: "cell.hover(variant fill + field.border_hover)",
        status: ImplementationStatus::Implemented,
    },
    StateDoc {
        state: "Active",
        selector: ".input-otp__slot[data-active=\"true\"]",
        description: "Focused slot carries the fake caret and focus background; keyboard modality adds the shared focus ring.",
        rust: "focused && i == cursor + active_bg + with_focus_ring",
        status: ImplementationStatus::Implemented,
    },
    StateDoc {
        state: "Filled",
        selector: ".input-otp__slot[data-filled=\"true\"]",
        description: "Slot containing a character keeps the focus background and animates the portable value entrance.",
        rust: "cell_ch != ' ' + active_bg + slot_value_motion",
        status: ImplementationStatus::Implemented,
    },
    StateDoc {
        state: "Disabled",
...
const INPUT_OTP_STYLING: &[StyleDoc] = &[
    ...
    StyleDoc {
        ...
        rust: "field border/background + field shadow + field_radius + 14px semibold",
        status: ImplementationStatus::Implemented,
    },
    StyleDoc {
    ...
    StyleDoc {
        ...
        rust: "hover(variant background + field.border_hover)",
        status: ImplementationStatus::Implemented,
    },
    StyleDoc {
        ...
        rust: "active_bg + with_focus_ring on the cursor slot",
        status: ImplementationStatus::Partial,
    },
    StyleDoc {
        ...
        rust: "active_bg + slot_value_motion",
        status: ImplementationStatus::Implemented,
    },
    StyleDoc {
    ...
    StyleDoc {
        ...
        rust: "danger border + field focus background with active precedence",
        status: ImplementationStatus::Partial,
    },
    StyleDoc {
        ...
        rust: "18px/24px text + 250ms smooth opacity entrance; GPUI has no public scale/translate builder",
        status: ImplementationStatus::Partial,
    },
    StyleDoc {
        ...
        rust: "relative slot + absolute 2x16px alignment + anim::caret_blink",
        status: ImplementationStatus::Partial,
    },
    StyleDoc {
...
pub(super) const INPUT_OTP: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.5",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(forms)/input-otp.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/input-otp/input-otp.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/input-otp.css",
...
const NUMBER_FIELD_API: &[ApiDoc] = &[
    ...
    ApiDoc { owner: "NumberField", prop: "focusRing", ty: "boolean", default: "true", description: "GPUI extension: hides only the group's visual focus ring while retaining focus, editing and stepper behavior.", rust_owner: "NumberField", rust: "focus_ring(bool)", status: ImplementationStatus::Implemented },
...
const NUMBER_FIELD_STATES: &[StateDoc] = &[
    ...
    StateDoc { state: "Hovered", selector: ".number-field__group:hover / buttons[data-hovered=true]", description: "The enabled unfocused group uses the pinned hover fill and border; the fill interpolates over 150ms ease-smooth while the border endpoint remains immediate. Button hover intentionally has no additional rule body.", rust: "group hover_fade_with_duration_and_easing(150ms, EaseSmooth) + border hover", status: ImplementationStatus::Partial },
...
pub(super) const NUMBER_FIELD: ReferenceMetadata = ReferenceMetadata {
    ...
    version: "3.2.5",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(forms)/number-field.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/number-field/number-field.tsx + https://github.com/adobe/react-spectrum/blob/react-aria-components@1.21.0/packages/react-aria-components/src/NumberField.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/number-field.css",
...
pub(super) const FORM: ReferenceMetadata = ReferenceMetadata {
    ...
    source_module: "form",
    version: "3.2.5",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(forms)/form.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/form/form.tsx + https://github.com/adobe/react-spectrum/blob/react-aria-components@1.21.0/packages/react-aria-components/src/Form.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components",
...
pub(super) const FIELDSET: ReferenceMetadata = ReferenceMetadata {
    ...
    source_module: "field",
    version: "3.2.5",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(forms)/fieldset.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/fieldset/fieldset.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/fieldset.css",
...
const FIELD_SLOTS_API: &[ApiDoc] = &[
    ...
    ApiDoc {
        ...
        ty: "ElementId",
        default: "—",
        description: "GPUI extension: stable identity used to retain the last message and animate the v3 height/opacity transition across validation updates.",
        rust_owner: "FieldError",
        rust: "FieldError::new().id(id)",
        status: ImplementationStatus::Implemented,
    },
    ApiDoc {
        owner: "FieldError",
...
const FIELD_SLOTS_PARTS: &[PartDoc] = &[
    ...
    PartDoc {
        name: "ErrorMessage",
        slot: "errorMessage",
        description: "`text-xs wrap-break-word text-danger` on the `.error-message` BEM class; shared field wrappers retain its body and animate the visibility transition.",
        rust_owner: "ErrorMessage",
        status: ImplementationStatus::Implemented,
    },
    PartDoc {
        name: "FieldError",
        slot: "field-error",
        description: "`.field-error` adds `px-1` and the collapsible `h-0 opacity-0 data-visible:h-auto` behaviour to the error text. The port keeps the 4px horizontal padding, retains the last message during exit, and drives the height and opacity timelines when a stable id is available.",
        rust_owner: "FieldError",
        status: ImplementationStatus::Implemented,
    },
];
...
const FIELD_SLOTS_STYLING: &[StyleDoc] = &[
    ...
    StyleDoc {
        ...
        description: "12px danger text; shared field wrappers retain its body and interpolate opacity over 150ms ease-out while the row height settles over 350ms ease-smooth.",
        rust: "anim::field_error_panel + Motion::FIELD_ERROR_HEIGHT + Motion::FIELD_ERROR_OPACITY",
        status: ImplementationStatus::Implemented,
    },
    StyleDoc {
        ...
        description: "The 4px horizontal padding is the only spacing `.field-error` adds over `.error-message`; a stable field id retains the body through exit and collapses its measured height to zero after the pinned transition.",
        rust: "anim::field_error_panel + px(px(4.)) + panel_phase",
        status: ImplementationStatus::Implemented,
    },
];
...
pub(super) const FIELD_SLOTS: ReferenceMetadata = ReferenceMetadata {
    ...
    source_module: "field",
    version: "3.2.5",
    docs_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(forms)/label.mdx + https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(forms)/description.mdx + https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(forms)/error-message.mdx + https://github.com/heroui-inc/heroui/blob/v3.2.5/apps/docs/content/docs/en/react/components/(forms)/field-error.mdx",
    api_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/label/label.tsx + https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/description/description.tsx + https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/error-message/error-message.tsx + https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/react/src/components/field-error/field-error.tsx",
    style_source: "https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/label.css + https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/description.css + https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/error-message.css + https://github.com/heroui-inc/heroui/blob/v3.2.5/packages/styles/components/field-error.css",
